                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{ (!empty($data->photo)) ? asset('upload/admin_images/'.$data->photo) : asset('upload/no_image.jpg') }}" alt="{{ $data->name }}" class="rounded-circle p-1 bg-primary" width="110">
                            <div class="mt-3">
                                <h4>{{ $data->name }}</h4>
                                <p class="text-secondary mb-1">{{'Role: ' . $data->role }}</p>
                                <p class="text-muted font-size-sm">{{ 'Address: ' . $data->address }}</p>
                                <p class="text-secondary mb-1">{{ 'Phone: ' . $data->phone }}</p>
                                <p class="text-secondary mb-1">{{ 'Email: ' . $data->email }}</p>
                            </div>
                        </div>
                        <hr class="my-4" />
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $data->id }}" class="form-control mb-3">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ (!empty($data->photo)) ? asset('upload/admin_images/'.$data->photo) : asset('upload/no_image.jpg') }}" alt="{{ $data->name }}" style="width:100px; height: 100px;">
                                </div>
                            </div>
