        ...
        <div class="navbar-area">
            ...
            <div class="mobile-nav">
                <a href="index.html" class="logo">
                    <img src="{{asset('frontend/assets/img/logos/logo-3.png')}}" class="logo-one" alt="Logo">
                    <img src="{{asset('frontend/assets/img/logos/footer-logo3.png')}}" class="logo-two" alt="Logo">
                </a>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <div class="form-group">
                                                <input type="text" name="username" id="username" class="form-control" required data-error="Please enter your Username or Email Or Phone Number" placeholder="Username or Email">
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-widget">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{asset('frontend/assets/img/logos/footer-logo3.png')}}" alt="Images">
                                    </a>
                                </div>
                                <p>
