                    ...
                    <div class="col-lg-12 mx-auto">
						<div class="card">
							<div class="card-header px-4 py-3">
								<h5 class="mb-0">Add Book Area</h5>
							</div>
                            <form action="{{ route('admin.book_areas.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                            <div class="card-body p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="short_title" name="short_title" placeholder="Short Title" value="{{ old('short_title') }}">
                                        @error('short_title')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="main_title" name="main_title" placeholder="Main Title" value="{{ old('main_title') }}">
                                        @error('main_title')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="url" class="form-control" id="link_url" name="link_url" placeholder="Link URL" value="{{ old('link_url') }}">
                                        @error('link_url')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
